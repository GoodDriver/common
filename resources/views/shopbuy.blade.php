...
@foreach($carts as $cart)
                  <tr>
                    <td class="col-sm-8 col-md-6">
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="/photos/p1.jpg" style="width: 100px; height: 72px;"> </a>
                    ...
                    <td class="col-sm-1 col-md-1">
                        <a href="/shop/edit?rowId={{$cart->rowId}}"> <button type="button" class="btn btn-danger">
  ...
  @endforeach
                ...
                <tr>
                    ...
                    <td>
                        <a href="/shop/list"> <button type="button" class="btn btn-default">
                                <span class="fa fa-shopping-cart"></span> 继续购物
                            </button>
                        </a></td>
                    <td>   <a href="/shop/del"> <button type="button" class="btn  btn-danger">
